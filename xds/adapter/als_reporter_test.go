...
func TestALSReporterAccessLog(t *testing.T) {
	tbntime.WithCurrentTimeFrozen(func(cs tbntime.ControlledSource) {
		...
		ar.reportAccessLog(
			...
			&envoylog.HTTPResponseProperties{
				ResponseCode: &types.UInt32Value{Value: 300, XXX_NoUnkeyedLiteral: struct{}{}, XXX_sizecache: 32},
			},
		)
		...
		ar.reportAccessLog(
			...
			&envoylog.HTTPResponseProperties{
				ResponseCode: &types.UInt32Value{Value: 400, XXX_NoUnkeyedLiteral: struct{}{}, XXX_sizecache: 32},
			},
		)
		...
		ar.reportAccessLog(
			...
			&envoylog.HTTPResponseProperties{
				ResponseCode: &types.UInt32Value{Value: 500, XXX_NoUnkeyedLiteral: struct{}{}, XXX_sizecache: 32},
			},
		)
		...
		ar.reportAccessLog(
			&envoylog.HTTPRequestProperties{
				Scheme:    "https",
				Authority: "example.com",
				Port:      &types.UInt32Value{Value: 8080, XXX_NoUnkeyedLiteral: struct{}{}, XXX_sizecache: 32},
				Path:      "/logged-500",
			},
			&envoylog.HTTPResponseProperties{
				ResponseCode: &types.UInt32Value{Value: 500, XXX_NoUnkeyedLiteral: struct{}{}, XXX_sizecache: 32},
...
func TestALSReporterAccessAndUpstreamLog(t *testing.T) {
	tbntime.WithCurrentTimeFrozen(func(cs tbntime.ControlledSource) {
		...
		ar.reportUpstreamLog(
			...
			&envoylog.HTTPResponseProperties{
				ResponseCode: &types.UInt32Value{Value: 201, XXX_NoUnkeyedLiteral: struct{}{}, XXX_sizecache: 32},
			},
		)
		...
		for i := 0; i < 10; i++ {
			for j := i; j < 10; j++ {
				...
				ar.reportAccessLog(
					...
					&envoylog.HTTPResponseProperties{
						ResponseCode: &types.UInt32Value{Value: r, XXX_NoUnkeyedLiteral: struct{}{}, XXX_sizecache: 32},
					},
				)
			}
		}
