...
```console
docker run turbinelabs/rotor:0.18.1 rotor <platform> --help
```
...
`docker run turbinelabs/rotor:0.18.1 rotor --help`. Global flags can be be
...
`docker run turbinelabs/rotor:0.18.1 rotor <platform> --help`. Per-platform
