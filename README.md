...
```console
$ docker run turbinelabs/rotor:0.17.1 rotor <platform> --help
```
...
```json
{
  ...
  "container": {
    "type": "DOCKER",
    "docker": {
      "image": "turbinelabs/rotor:0.17.1",
      "forcePullImage": true
    }
  },
  "env": {
...
`docker run turbinelabs/rotor:0.17.1 rotor --help`. Global flags can be be
...
`docker run turbinelabs/rotor:0.17.1 rotor <platform> --help`. Per-platform
